...
X = data.drop(['y', 'poutcome', 'duration'], axis=1)
y = data['y']
...
mlp_classifier = MLPClassifier(hidden_layer_sizes=297, random_state=0, alpha=0.0029797690517799937, learning_rate_init=0.06258315722416379,
